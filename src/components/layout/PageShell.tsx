...
const PageShell = ({
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#02050a] text-slate-100">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(34,197,94,0.18),_transparent_38%),radial-gradient(circle_at_80%_10%,_rgba(56,189,248,0.16),_transparent_28%),linear-gradient(180deg,_rgba(7,17,31,10.1),_rgba(7,17,31,0.1))]" />
      ...
      <section className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-10 pt-8 sm:px-8 lg:px-10 lg:pb-14 lg:pt-12">
        <div className="max-w-3xl rounded-lg border border-white/10 bg-white/5 p-8 sm:p-10\">
